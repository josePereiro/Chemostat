...
function maxent_ep(K::AbstractArray{T,2}, Y::Array{T,1}, lb::Array{T,1}, ub::Array{T,1};
    ...
    obj_idx::Integer = -1, # maxent objective flx index
    beta_maxent::Real = 0.0, # maxenet inverse temperature
...
beta_mv = prepare_maxent_beta_v(epmat, beta_maxent, obj_idx)
epalg = EPAlg(beta, beta_mv, minvar, maxvar, epsconv, damp, maxiter, verbose)
