function Base.setindex!(boundle::ChstatBoundle, data, ξ::Real, β::Real, data_key::Symbol)
...
function Base.setindex!(boundle::ChstatBoundle, data, ξ::Real, data_key::Symbol)
    _check_data_key(data_key, data)
...
function Base.setindex!(boundle::ChstatBoundle, data, data_key::Symbol)
    _check_data_key(data_key, data)
